/*
 * Nombre del archivo: Practica Final Sistemas Embebidos Tarjeta 1
 * Descripción:
...
uint8_t devEui[] = { 0xA4, 0x13, 0x6F, 0xFA, 0x12, 0xF4, 0x00, 0x00 };
uint8_t appEui[] = { 0xEC, 0xFF, 0x9F, 0xFA, 0x12, 0xF4, 0x00, 0x00 };
uint8_t appKey[] = { 0x62, 0x25, 0x21, 0x67, 0x4D, 0x2F, 0xA1, 0xDB, 0xBD, 0xD7, 0x25, 0xE5, 0x22, 0x22, 0x27, 0xB1 };
